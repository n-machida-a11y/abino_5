...
'--------------------------------------------------------------------------------
' 【何のファイル？】
'   管理者用xlsm に「最新の VBA コード一式」を一括取り込むためのツール。
'   v3 方式：標準モジュールは完全置換、ユーザーフォームはコード本体だけ
'   書き換えて画面レイアウト（コントロール配置）は壊さない。
'
' 【使うとき】
'   - お客様 xlsm を最新化するとき
'   - キット側で .bas / .frm を更新した後、現地で取り込み
'
' 【手順】
'   1. xlsm を開く  2. Alt+F11 でVBE  3. このファイルをインポート
'   4. Alt+F8 で「InstallAll」実行  5. キットフォルダを選択
'================================================================================
